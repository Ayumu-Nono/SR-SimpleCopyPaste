...
# masked image before augmentation
im_masked = Image.composite(im, im_bk, mask)
im_masked.save('img/masked.jpg')
...
], random_order=False, random_state=1)
...
# masked image after augmentation
im_masked1 = Image.composite(aug_img_jpg, im_bk, aug_mask_jpg)
im_masked1.save('img/masked1.jpg')
